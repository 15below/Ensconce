...
{
    [TestFixture]
    public class SubscriptionInfoFileLoaderTests
    {
        ...
        {
            var result = SubscriptionInfoFileLoader.GetSubscription(mockEmailSubInfoContents.ToArray(), "D:/MockPath", "TestSubscription");
        ...
        {
            var result = SubscriptionInfoFileLoader.GetSubscription(mockFileShareSubInfoContents.ToArray(), "D:/MockPath", "TestSubscription");
        ...
        public string GetSubscription_GivenSubInfoFileContentsAndSubscriptionTypeAndRenderFormat_ShouldReturnExpectedReportSubscriptionWithRenderFormat(string subscriptionType, string renderFormat)
        {
            ...
            if (subscriptionType == "Email")
            {
                ...
                result = SubscriptionInfoFileLoader.GetSubscription(mockEmailSubInfoContents.ToArray(), "D:/MockPath", "TestSubscription");
            }
            else
            {
                ...
                result = SubscriptionInfoFileLoader.GetSubscription(mockFileShareSubInfoContents.ToArray(), "D:/MockPath", "TestSubscription");
            }

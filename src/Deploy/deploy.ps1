...
{
	$tools = @(
		[pscustomobject]@{CacheName='Az-Installer';Tool='Az-Installer';Version='2.82.0';ExeName='azure-cli.msi';RunExe=$true;RunArgs="/quiet /norestart";OctoAgent=$true}
		[pscustomobject]@{CacheName='Kube-Linter';Tool='Kube-Linter';Version='0.8.1';ExeName='kube-linter.exe';RunExe=$false;RunArgs="";OctoAgent=$true}
		...
		[pscustomobject]@{CacheName='KubeCtl';Tool='KubeCtl';Version='1.33.7';ExeName='kubectl.exe';RunExe=$false;RunArgs="";OctoAgent=$true}
	)

...
{
	$tools = @(
		[pscustomobject]@{CacheName='Az-Installer';Tool='Az-Installer';Version='2.89.1';ExeName='azure-cli.msi';RunExe=$true;RunArgs="/quiet /norestart";OctoAgent=$true}
		[pscustomobject]@{CacheName='Kube-Linter';Tool='Kube-Linter';Version='0.8.3';ExeName='kube-linter.exe';RunExe=$false;RunArgs="";OctoAgent=$true}
		...
		[pscustomobject]@{CacheName='KubeCtl';Tool='KubeCtl';Version='1.35.6';ExeName='kubectl.exe';RunExe=$false;RunArgs="";OctoAgent=$true}
	)

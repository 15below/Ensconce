...
namespace Ensconce
{
    internal static class Program
    {
        ...
        {
            var finaliseTime = Stopwatch.StartNew();
            ...
            using (var repo = GetOrCreateFinaliseRepository(directory))
            {
                ...
                if (filesStaged)
                {
                    ...
                    Log("Finalise complete, took {0:n0}ms", finaliseTime.ElapsedMilliseconds);
                }
                else
                {
                    Log("Nothing to finalise, took {0:n0}ms", finaliseTime.ElapsedMilliseconds);
                }
            }
        }
